...
import { SiteSchema, newsSchema, types } from '@/lib/schemas/site';
...
export function NewsForm({ formValues, isOpen, setIsOpen, refresh }: iSiteForm) {
						...
						<form onSubmit={form.handleSubmit(onSubmit)}>
							...
							<div className='grid grid-cols-2 gap-2 my-3'>
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-extrabold">{t('date')}</FormLabel>
											<FormControl>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-extrabold">{t('label')}</FormLabel>
											<FormControl>
												<Input placeholder='Enter title' {...field} />
											</FormControl>
											<FormMessage />
